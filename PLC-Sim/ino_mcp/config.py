...
def _mcp_config_files() -> Iterable[Path]:
    explicit = os.environ.get("PLCSIM_MCP_CONFIG")
    if explicit:
...
def resolve_mcp_config(
    *,
    ...
    env_values = {
        "bundle_js": os.environ.get("PLCSIM_MCP_BUNDLE"),
        "codesys_path": os.environ.get("PLCSIM_INOPROSHOP_EXE"),
        "codesys_profile": os.environ.get("PLCSIM_INOPROSHOP_PROFILE"),
        "workspace": os.environ.get("PLCSIM_MCP_WORKSPACE"),
        "node_cmd": os.environ.get("PLCSIM_NODE"),
    }
