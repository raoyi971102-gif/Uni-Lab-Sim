...
class McpClient:
    ...
    def start(self, *, list_tools: bool = True) -> None:
        ...
        self._session_dir = Path(tempfile.mkdtemp(prefix="plcsim-ino-session-"))
        child_env = os.environ.copy()
        child_env["PLCSIM_INO_SESSION_DIR"] = str(self._session_dir)
        ...
        resp = self._request("initialize", {
            ...
            "clientInfo": {"name": "PLC-Sim-InoBridge", "version": "1.0.0"},
        }, timeout=60.0)
